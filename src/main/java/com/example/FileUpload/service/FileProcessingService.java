   ...
   // private final ResumeParsedRepository resumeParsedRepository;
    ...
    public String parseResume(MultipartFile file) throws IOException {
        ...
        List<Experience> experienceList = new ArrayList<>();
          ...
          experience.setExperience(resumeData.path("Experience").asText());
         // experience.setSegregatedExperience();
          experience.setJobProfile(resumeData.path("JobProfile").asText());
          experience.setCurrentEmployer(resumeData.path("CurrentEmployer").asText());
          experience.setTotalExperienceInYear(resumeData.path("TotalExperienceInYear").asText());
          experience.setTotalExperienceInMonths(resumeData.path("TotalExperienceInMonths").asText());
          experience.setTotalExperienceRange(resumeData.path("TotalExperienceRange").asText());
            experience.setResume(parsedResume);
            experienceList.add(experience);
        parsedResume.setExperienceList(experienceList);
        parsedResume.getExperienceList().add(experience);
...
System.out.println("Response" + parsedData);
        return parsedData;
    }
